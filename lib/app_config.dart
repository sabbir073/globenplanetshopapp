...
class AppConfig {
  static String copyright_text = "@ Globenplanet " + this_year; //this shows in the splash screen
  static String app_name = "Globenplanet Shop"; //this shows in the splash screen
  static String purchase_code = "299bbdb9-119d-448e-97a5-7d3d65153428"; //enter your purchase code for the app from codecanyon

  //configure this
  static const bool HTTPS = true;

  //configure this
  static const DOMAIN_PATH = "shop.globenplanet.com"; //localhost
